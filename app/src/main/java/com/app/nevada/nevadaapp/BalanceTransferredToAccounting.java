 ...
 */
public class BalanceTransferredToAccounting extends AppCompatActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_balance_transferred_to_accounting);
    ...
    public void reFillList(View v)
    {
        ...
        ListViewAdapters adapter=new ListViewAdapters(BalanceTransferredToAccounting.this, tempArrayList);
    ...
    class subsidaryTask extends AsyncTask<Integer, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            ListViewAdapters adapter=new ListViewAdapters(BalanceTransferredToAccounting.this, list);
            listView.setAdapter(adapter);
            ...
            ArrayAdapter<String> spAdapter = new ArrayAdapter<String>(BalanceTransferredToAccounting.this, android.R.layout.simple_spinner_item, spinnerArray);
            spAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            Spinner sItems = (Spinner) findViewById(R.id.tranTypeFilter);
            sItems.setAdapter(spAdapter);

            adapter=new ListViewAdapters(BalanceTransferredToAccounting.this, list);
            listView.setAdapter(adapter);
            listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener()
            {
                ...
                public boolean onItemLongClick(AdapterView<?> parent, final View view, int position, long id)
                {
                    if (varIsAdmin.equals("1")){
                        ...
                        Intent myIntent = new Intent(BalanceTransferredToAccounting.this, LastTransActionActivity.class);
                        myIntent.putExtra("varSource","2");
                        myIntent.putExtra("varTranType",varTranType);
                        myIntent.putExtra("varTranNo",varTranNo);
                        BalanceTransferredToAccounting.this.startActivity(myIntent);
                    }
                    return true;
                }
